...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountriesBox = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    //we don't need to call this ourselves, react will do it
	  ...
	  handleButtonClick: function handleButtonClick(countryCode) {
	  ...
	  render: function render() {
	    ...
	    if (this.state.displayCountry) {
	      displayElement = React.createElement(CountryDisplay, { buttonClicked: this.handleButtonClick, country: this.state.displayCountry });
	    }
	...
	var CountryDisplay = React.createClass({
	  ...
	  render: function render() {
	    ...
	    for (var i = 0; i < filteredKeys.length; i++) {
	      allData.push(React.createElement(
	        'p',
	        { key: i },
	        filteredKeys[i],
	        ': ',
	        country[filteredKeys[i]]
	      ));
	    };
	    return React.createElement(
	      'div',
	      null,
	      allData,
	      React.createElement(BorderingCountries, { onButtonClick: this.props.buttonClicked, countries: this.props.country.borders })
	    );
	  }
	});
